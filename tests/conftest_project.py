...
@pytest.fixture
def dbt_oracle_profile() -> FlextCore.Types.Dict:
...
@pytest.fixture
def dbt_project_config() -> FlextCore.Types.Dict:
...
@pytest.fixture
def oracle_adapter_config() -> FlextCore.Types.Dict:
...
@pytest.fixture
def dbt_model_definitions() -> FlextCore.Types.StringDict:
...
@pytest.fixture
def dbt_macro_definitions() -> FlextCore.Types.StringDict:
...
# dbt test fixtures
@pytest.fixture
def dbt_test_definitions() -> FlextCore.Types.StringDict:
...
@pytest.fixture
def dbt_source_definitions() -> FlextCore.Types.Dict:
...
# Oracle SQL fixtures
@pytest.fixture
def oracle_sql_queries() -> FlextCore.Types.StringDict:
...
@pytest.fixture
def dbt_run_config() -> FlextCore.Types.Dict:
...
@pytest.fixture
def dbt_test_config() -> FlextCore.Types.Dict:
...
@pytest.fixture
def performance_test_config() -> FlextCore.Types.Dict:
...
@pytest.fixture
def dbt_error_scenarios() -> list[FlextCore.Types.Dict]:
...
class MockConnectionManager:
    ...
    def __init__(self) -> None:
        ...
        self.connections: FlextCore.Types.Dict = {}
...
class MockSqlExecutor:
    ...
    ) -> tuple[str, FlextCore.Types.List]:
...
class MockModelCompiler:
    ...
    def compile_model(self, model_sql: str, context: FlextCore.Types.Dict) -> str:
...
class MockRelationManager:
    ...
    def list_relations_without_caching(
        self,
        schema: str,
    ) -> list[FlextCore.Types.StringDict]:
...
def mock_dbt_oracle_adapter() -> object:
    ...
    class MockDbtOracleAdapter:
        ...
        def open_connection(self, name: str) -> FlextCore.Types.Dict:
