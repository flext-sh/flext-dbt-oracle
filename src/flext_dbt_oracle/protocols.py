...
class FlextDbtOracleProtocols(FlextProtocols):
    """DBT Oracle protocols extending FlextProtocols with DBT Oracle-specific interfaces.
    ...
    class OracleIntegrationProtocol(FlextProtocols.Domain.Service, Protocol):
        ...
        def extract_oracle_data(
            self, oracle_config: dict[str, object], extraction_config: dict[str, object]
    ...
    class QualityProtocol(FlextProtocols.Domain.Service, Protocol):
        ...
        def validate_oracle_schema_compliance(
            self, oracle_data: list[dict[str, object]], schema_rules: dict[str, object]
        ) -> FlextResult[dict[str, object]]:
    ...
    DbtOracleIntegrationProtocol = OracleIntegrationProtocol
    DbtOracleModelingProtocol = ModelingProtocol
    DbtOracleTransformationProtocol = TransformationProtocol
    DbtOracleMacroProtocol = MacroProtocol
    DbtOracleQualityProtocol = QualityProtocol
    DbtOraclePerformanceProtocol = PerformanceProtocol
    DbtOracleMonitoringProtocol = MonitoringProtocol
