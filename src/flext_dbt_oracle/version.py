"""Project metadata for flext dbt oracle."""
...
class FlextDbtOracleVersion(FlextProjectVersion):
    """Structured metadata for the flext dbt oracle distribution."""

    @classmethod
    def current(cls) -> FlextDbtOracleVersion:
        """Return canonical metadata loaded from pyproject.toml."""
        return cls.from_metadata(_metadata_obj)


VERSION: Final[FlextDbtOracleVersion] = FlextDbtOracleVersion.current()
...
__all__ = ["VERSION", "FlextDbtOracleVersion", "__version__", "__version_info__"]
