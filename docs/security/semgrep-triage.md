...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 605 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-dbt-oracle.json`
